...
import io.mosip.credential.constant.DateUtilConstants;
import io.mosip.credential.exception.NullPointerException;
...
public final class DateUtils {
	...
	public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
		...
		try {
			...
			throw new io.mosip.credential.exception.ParseException(
