package io.mosip.credential.spi;
...
public interface TemplateManager {
	 ...
	 * 
	 * @param template the {@link InputStream} is template content .
	 * @param values   as Map&lt;String,Object &gt; where key will be placeholder
	 *                 name and Object is the actual value for the placeholder
	 ...
	 * @param values       as Map&lt;String,Object &gt; where key is placeholder
	 *                     name and Object is Placeholder value
	 ...
	 * 
	 * @param templateName name of the template to be used in merge
	 * @param writer       output writer for render template
	 * @param values       as Map&lt;String,Object &gt; where key is placeholder
	 *                     name and Object is value for the placeholder
	 * @param encodingType as String like UTF-8,UTF-16 etc.
	 * @return boolean true if successfully, false otherwise
	 * @throws IOException if an I/O exception occurs during writing to the writer
	 */
